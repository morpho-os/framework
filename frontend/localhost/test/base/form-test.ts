...
class Page {
    ...
    public static emptyForm(): Form {
        return new Form({el: Page.emptyFormEl()});
    }
    ...
    public static withRequiredElsForm(): any {
        return new Form({el: Page.withRequiredElsFormEl()});
    }
}
...
describe("Form", function () {
    ...
    describe('Validation', function () {
        ...
        it('invalidEls() before validation', function () {
            const form = new Form({el: Page.withRequiredElsFormEl()});
    ...
    it('els() non-empty form', function () {
        const form = new Form({el: $('#non-empty-form')});
    ...
    it('send() - response errors', function (done) {
        const form = new Form({el: $('#server-error-form')});
        form.send()
            .then(() => {
                checkTrue(form.hasErrors());
                done();
