...
class PasswordManagerTest extends TestCase
{
    public function testGeneratePassword()
    {
        ...
        }, 31, PasswordManager::USE_UPPER_CHARS | PasswordManager::USE_DIGIT_CHARS);
        $this->checkPassword(function ($password) {
            return (bool) \preg_match('~^[[:punct:]]+$~', $password);
        }, 20, PasswordManager::USE_CONFUSED_CHARS);
        $this->checkPassword(function ($password) {
        ...
        }, 25, PasswordManager::USE_PUNCT_CHARS ^ PasswordManager::USE_CONFUSED_CHARS);
    }
