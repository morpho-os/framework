...
class Assert {
    ...
    public static function isOneOf($needle, array $haystack)/*: void */ {
        self::isTrue(in_array($needle, $haystack, true), 'The value is not one of the provided values');
    }

    public static function hasOnlyKeys(array $arr, array $allowedKeys)/*: void */ {
    ...
    public static function hasKeys(array $arr, array $requiredKeys)/*: void */ {
    ...
    public static function inArray($value, $array)/*: void */ {
        self::isTrue(in_array($value, $array, true), "Value '$value' was not found in array");
    }

    public static function inRange($value, $start, $end)/*: void */ {
    ...
    public static function isTrue($result, string $message = null)/*: void */ {
        $result = (bool)$result;
        if ($result === false) {
